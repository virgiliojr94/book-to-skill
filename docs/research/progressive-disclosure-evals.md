...
| PD-02 | DONE | — | `tests/evals/test_score.py`, `tests/evals/test_replay.py` | Five synthetic trajectories; deterministic replay; focused pytest and Ruff passed locally |
