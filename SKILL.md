...
5. If the choice requires knowing the host (project-local output, or the Claude Code symlink) and you cannot identify it, ask: "Which agent are you running this in — GitHub Copilot CLI, Amp, or Claude Code?"
